...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController.addOnDestinationChangedListener{_, destination, _ -> if(destination.id == R.id.nav_about){
        ...
        val backPressedCallback = object: OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                ...
                exitDialogFragment.show(supportFragmentManager,"Exit Dialog")
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            builder.setMessage(getString(R.string.exit_message))
                .setPositiveButton(getString(R.string.exit),{
                    dialog,id ->
                    requireActivity().finish()//Terminate app
                })
